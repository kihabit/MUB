...
public class FacebookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mainView = inflater.inflate(R.layout.fragment_facebook_fb, container, false);
...
//                    intent.setPackage("com.prayosof.yvideo");
//                    startActivity(intent);
                } else {
                    Toast.makeText(getContext(), "Please Connect to Internet", Toast.LENGTH_LONG).show();
                }
    ...
    public void downloadvideo(String pathvideo) {
        if (pathvideo.contains(".mp4")) {
            ...
            File root = new File(Environment.getExternalStorageDirectory() + File.separator + HomeFragment.VIDEO_DW_DIR);
