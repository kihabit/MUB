...
public class VideoPlayerActivity extends Activity implements SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, VideoControllerView.MediaPlayerControl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_player_fb);

        videoSurface = (SurfaceView) findViewById(R.id.videoSurface_fb);
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        controller.setAnchorView((FrameLayout) findViewById(R.id.videoSurfaceContainer_fb));
        player.start();
    }
...
// End VideoMediaController.MediaPlayerControl
    ...
    public void setFullScreen(boolean fullScreen) {
...

        {
            ...
            DisplayMetrics displaymetrics = new DisplayMetrics();
            getWindowManager().getDefaultDisplay().getMetrics(displaymetrics);
            final FrameLayout mFrame = (FrameLayout) findViewById(R.id.videoSurfaceContainer_fb);
            // int height = displaymetrics.heightPixels;
