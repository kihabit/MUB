...
public class ZoomableExoPlayerView extends FrameLayout {
    ...
    public ZoomableExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean controllerHideOnTouch = false;
        ...
        final PlayerControlView customController = findViewById(R.id.exo_controller);
...
//        }
     ...
     * <p>
     * </p><p>To transition a {@link Player} from targeting one view to another, it's recommended to use
     ...
     * </p><p>
     * </p><p>If enabled, the currently displayed video frame or media artwork will be kept visible until
     ...
     * </p><p>
     * </p><p>If disabled, the currently displayed video frame or media artwork will be hidden as soon as
     ...
     * </p><p>
     * </p><p>The playback controls are automatically hidden during playback after {{@link
     ...
     * surface_view}.
     * </li><li>{@link TextureView} if {@code surface_type} is {@code texture_view}.
     * </li><li>{@code null} if {@code surface_type} is {@code none}.
     * </li></ul>
     *
    ...
    private void updateErrorMessage() {
        if (errorMessageView != null) {
            ...
            if (error != null) {
                CharSequence errorMessage = (CharSequence) errorMessageProvider.getErrorMessage(error).second;
