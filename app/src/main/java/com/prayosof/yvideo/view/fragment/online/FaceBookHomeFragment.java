 ...
 * Use the {@link FaceBookHomeFragment#newInstance} factory method to
...
public class FaceBookHomeFragment extends Fragment {
    ...
    public static FaceBookHomeFragment newInstance(int position) {
        FaceBookHomeFragment f = new FaceBookHomeFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainView=inflater.inflate(R.layout.fragment_face_book_home,container,false);
    ...
    public void downloadvideo(String pathvideo)
    {
        ...
        {
            File directory = new File(Environment.getExternalStorageDirectory()+File.separator+"PDoVideos");
            directory.mkdirs();
            ...
            File root = new File(Environment.getExternalStorageDirectory() + File.separator+"PVideos");
