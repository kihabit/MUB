...
import com.prayosof.yvideo.databinding.ItemsFileViewBinding;
...
public class FileListAdapter extends RecyclerView.Adapter<FileListAdapter.ViewHolder> {
    ...
    private FileListClickInterface clickInterface;

    public FileListAdapter(Context context, ArrayList<File> files, FileListClickInterface clickInterface) {
    ...
    public FileListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ViewHolder((ItemsFileViewBinding) DataBindingUtil.inflate(layoutInflater, R.layout.items_file_view, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull FileListAdapter.ViewHolder viewHolder, final int i) {
        final File fileItem = fileArrayList.get(i);
        ...
        try {
            ...
            Glide.with(context).load(fileItem.getPath()).into(viewHolder.mbinding.pc);
        }catch (Exception ex){
        }
        ...
        viewHolder.mbinding.rlMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clickInterface.getPosition(i,fileItem);
            }
        });
    }
