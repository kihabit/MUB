...
import com.prayosof.yvideo.view.activity.FacebookActivity
...
class DownloadFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        root.facebookBtn.setOnClickListener{


            val i = Intent(requireActivity(), FacebookActivity::class.java)
...
//            activity?.let{
//                val intent = Intent (it, FacebookActivity::class.java)
