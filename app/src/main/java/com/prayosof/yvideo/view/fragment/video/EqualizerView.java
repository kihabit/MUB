...
import com.prayosof.yvideo.adapter.BaseRecyclerAdapter;
import com.prayosof.yvideo.adapter.OnSeekBarChangeListenerAdapter;
...
//            mAudioEffects.saveEqualizerSettings(CustomExoPlayerActivity.mEqualizer.getProperties());
    ...
    private static final class AdapterImpl extends BaseRecyclerAdapter<Item, VH> {
        ...
        public VH onCreateViewHolder(@NonNull final ViewGroup parent, final int viewType) {
            final VH vh = new VH(getLayoutInflater().inflate(
                    R.layout.equ_band, parent, false));
