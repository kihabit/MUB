...
//            CreateNotification.createNotification(this, audioList.get(audioIndex),
...
//                R.drawable.exo_controls_play, audioIndex, audioList.size()-1);
    ...
    private void register_playNewAudio() {
        ...
        IntentFilter filter = new IntentFilter(NewAudioActivity.Broadcast_PLAY_NEW_AUDIO);
        registerReceiver(playNewAudio, filter);
    }


    private BroadcastReceiver broadcastReceiver_1= new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
...
//                            myCallback.onTrackPlay();
    ...
    private void register_notification_listner() {
        registerReceiver(broadcastReceiver_1, new IntentFilter("PAPPU_TRACKS"));
