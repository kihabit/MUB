...
import static com.prayosof.yvideo.view.fragment.duplicate_video.DuplicateDirectoryFragment.videoArrayList;
...
public class VideoPlay2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setSystemUiVisibility(SYSTEM_UI_FLAG_HIDE_NAVIGATION|SYSTEM_UI_FLAG_FULLSCREEN|SYSTEM_UI_FLAG_IMMERSIVE_STICKY);
        if (checkPermission()) {
            setVideo();
        }
    }
